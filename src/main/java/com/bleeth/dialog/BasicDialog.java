...
public class BasicDialog {
    ...
    protected void createContents() {
        ...
        shell.setText("五子棋大战");
        shell.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/chess.png"));


        composite = new Composite(shell, SWT.NONE);
        composite.setBackgroundImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/bg_2.jpg"));
        composite.setBounds(0, 0, 680, 360);

        button_one = new Button(composite, SWT.NONE);
        button_one.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/单人对战_1.jpg"));
        ...
        button_two.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/双人对战.jpg"));
        ...
        button_three.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/网络对战.jpg"));
        button_three.setBounds(267, 232, 160, 30);

        helpButton = new Button(composite, SWT.NONE);
        helpButton.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/帮助.jpg"));
        ...
        exitButton.setImage(ResourceUtil.getImage(ResourceUtil.RESOURCE_PATH + "/image/退出.jpg"));
